...
#define print2(x) std::cout << (x) << std::endl
...
unsigned long AccFpga::getTotalOutputSize(){
    unsigned long r = 0;
    for(int i = 0;i<m_num_outputs;++i){
